...
parser.add_argument("--learning_rate_min", type=float, default=0.001, help="final learning rate")
...
parser.add_argument("--auxiliary_weight", type=float, default=0.6, help="weight for auxiliary loss")
...
parser.add_argument("--arch", type=str, default="CIFAR_100_arch", help="which architecture to use")
